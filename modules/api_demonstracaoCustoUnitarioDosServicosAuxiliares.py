...
def api_demonstracaoCustoUnitarioDosServicosAuxiliares(
    ...
    """
    config = APIS_CONFIG["demonstracaoCustoUnitarioDosServicosAuxiliares"]
    
    return extrair_dados_api(
        diretorio_arquivo_competencia=diretorio_arquivo_competencia,
        caminho_to_save=caminho_to_save,
        nome_api="demonstracaoCustoUnitarioDosServicosAuxiliares",
